...
class AuthUserLocationPage extends StatelessWidget {
  ...
  const AuthUserLocationPage({super.key, this.controller, this.onComplete, this.automaticallyImplyLeading = false});

  void authCubitStateListener(BuildContext context, AuthState event) {
          ...
          children: [
            ...
            BlocConsumer<AuthCubit, AuthState>(
              ...
              builder: (context, authState) {
                ...
                }, expand: true, loading: authState.status == AuthStatus.setupAuthUserLocationInProgress,);
              },
            )
          ],
        ),
